...
export function AdminDashboardClient({ statsData, recentActivityData, systemStatusData, analyticsData, blacklistData }: AdminDashboardClientProps) {
  ...
  const renderContent = (itemId: string) => {
    switch (itemId) {
      case "overview":
        return <OverviewSection statsData={statsData} recentActivityData={recentActivityData} systemStatusData={systemStatusData} />;
      case "users":
        return <UsersSection />
      case "policies":
